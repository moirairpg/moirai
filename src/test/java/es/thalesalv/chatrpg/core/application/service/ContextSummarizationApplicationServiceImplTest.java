...
public class ContextSummarizationApplicationServiceImplTest {
    ...
    public void summarizeWith_validInput_thenSummaryGenerated() {
        ...
        when(discordChannelOperationsPort.retrieveLastMessagesInclusiveFrom(eq(channelId), eq(messageId), anyInt()))
        ...
        // When
        Mono<Map<String, Object>> result = service.summarizeWith(channelId, messageId, "botName", modelConfiguration);
    ...
    public void summarizeWith_whenSummaryExceedsTokenLimit_thenSummaryShouldBeTrimmed() {
        ...
        when(discordChannelOperationsPort.retrieveLastMessagesInclusiveFrom(anyString(), anyString(), anyInt()))
        ...
        // When
        Mono<Map<String, Object>> result = service.summarizeWith(channelId, messageId,
                botName, modelConfiguration);
    ...
    public void summarizeWith_whenSummaryNotExceedsTokenLimit_thenSummaryShouldNotBeTrimmed() {
        ...
        StepVerifier.create(result)
                .assertNext(processedContext -> {
                    ...
                    List<String> messageHistory = (List<String>) processedContext.get("messageHistory");
                    assertThat(messageHistory).isNotNull().isNotEmpty().hasSize(3);
                    assertThat(messageHistory).first().isEqualTo("test_user says: Message 3");
                    assertThat(messageHistory).last().isEqualTo("test_user says: Message 1");
                })
                .verifyComplete();
    ...
    public void summarizeWith_relevantMessagesIncludedUpToTokenLimit_thenCorrectMessagesSelected() {
        ...
        StepVerifier.create(result)
                .assertNext(processedContext -> {
                    ...
                    assertThat(messageHistory).first().isEqualTo("test_user says: Message 7");
                    assertThat(messageHistory).last().isEqualTo("test_user says: Message 1");
