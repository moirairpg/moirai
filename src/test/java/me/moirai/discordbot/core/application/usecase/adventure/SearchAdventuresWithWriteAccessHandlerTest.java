...
public class SearchAdventuresWithWriteAccessHandlerTest {

    @Mock
    private AdventureQueryRepository repository;

    @InjectMocks
    private SearchAdventuresWithWriteAccessHandler handler;
    ...
    public void searchAdventures() {
        ...
        when(repository.search(any(SearchAdventuresWithWriteAccess.class)))
