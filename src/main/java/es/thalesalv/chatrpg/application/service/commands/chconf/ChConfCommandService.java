...
public class ChConfCommandService implements DiscordCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChConfCommandService.class);
    ...
    private final ChConfGetHandler getHandler;
    private final ChConfSetHandler setHandler;
    private final ChConfListHandler listHandler;
