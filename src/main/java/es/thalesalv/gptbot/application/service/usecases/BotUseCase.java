...
public interface BotUseCase {
     ...
     */
    void generateResponse(final SelfUser bot, final User messageAuthor, final MessageEventData messageEventData, final MessageChannelUnion channel, final Mentions mentions, final GptModelService model);
}
