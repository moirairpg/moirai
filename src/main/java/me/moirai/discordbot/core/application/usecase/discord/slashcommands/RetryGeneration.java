...
public final class RetryGeneration extends UseCase<Mono<String>> {
    ...
    private RetryGeneration(Builder builder) {
    ...
    public static final class Builder {
        ...
        public RetryGeneration build() {
            return new RetryGeneration(this);
        }
    }
}
