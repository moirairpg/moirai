...
public final class AddFavoriteChannelConfig extends UseCase<Void> {

    private final String assetId;
    private final String playerDiscordId;

    private AddFavoriteChannelConfig(Builder builder) {
    ...
    public static final class Builder {
        ...
        public AddFavoriteChannelConfig build() {
            return new AddFavoriteChannelConfig(this);
        }
    }
}
