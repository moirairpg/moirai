...
public final class SearchAdventuresWithReadAccess extends UseCase<SearchAdventuresResult> {
    ...
    private SearchAdventuresWithReadAccess(Builder builder) {
    ...
    public static final class Builder {
        ...
        public SearchAdventuresWithReadAccess build() {
            return new SearchAdventuresWithReadAccess(this);
        }
    }
}