...
public final class SearchAdventuresWithWriteAccess extends UseCase<SearchAdventuresResult> {
    ...
    private SearchAdventuresWithWriteAccess(Builder builder) {
    ...
    public static final class Builder {
        ...
        public SearchAdventuresWithWriteAccess build() {
            return new SearchAdventuresWithWriteAccess(this);
        }
    }
}