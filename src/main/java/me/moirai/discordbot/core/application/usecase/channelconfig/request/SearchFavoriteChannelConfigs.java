...
public final class SearchFavoriteChannelConfigs extends UseCase<SearchChannelConfigsResult> {
    ...
    private SearchFavoriteChannelConfigs(Builder builder) {
    ...
    public static final class Builder {
        ...
        public SearchFavoriteChannelConfigs build() {
            return new SearchFavoriteChannelConfigs(this);
        }
    }
}