...
public final class SearchFavoritePersonas extends UseCase<SearchPersonasResult> {
    ...
    private SearchFavoritePersonas(Builder builder) {
    ...
    public static final class Builder {
        ...
        public SearchFavoritePersonas build() {
            return new SearchFavoritePersonas(this);
        }
    }
}