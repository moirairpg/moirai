...
public final class WorldAccessLevelChangedEvent implements DomainEvent {
    ...
    WorldAccessLevelChangedEvent(UUID worldPublicId, String worldName, Long userId, PermissionLevel level) {
