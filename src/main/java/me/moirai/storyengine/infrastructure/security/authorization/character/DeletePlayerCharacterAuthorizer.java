...
@Component
public class DeletePlayerCharacterAuthorizer implements OperationAuthorizer {

    private final PlayerCharacterReader reader;

    public DeletePlayerCharacterAuthorizer(PlayerCharacterReader reader) {
        this.reader = reader;
    }

    @Override
    public AuthorizationOperation getOperation() {
        return AuthorizationOperation.DELETE_PLAYER_CHARACTER;
    }
