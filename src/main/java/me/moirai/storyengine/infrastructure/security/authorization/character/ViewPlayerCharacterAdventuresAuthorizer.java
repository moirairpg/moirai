...
@Component
public class ViewPlayerCharacterAdventuresAuthorizer implements OperationAuthorizer {

    private final PlayerCharacterReader reader;

    public ViewPlayerCharacterAdventuresAuthorizer(PlayerCharacterReader reader) {
        this.reader = reader;
    }

    @Override
    public AuthorizationOperation getOperation() {
        return AuthorizationOperation.VIEW_PLAYER_CHARACTER_ADVENTURES;
    }
